...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=I386_EFI -m32 -nostdinc -isystem /usr/lib64/gcc/x86_64-slackware-linux/5.3.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
